...
const TableList = dynamic(() => import("@/app/components/akutansi/listrekening/table"))
const Pagination = dynamic(() => import("@/app/components/akutansi/listrekening/pagination"))
const Perpage = dynamic(() => import("@/app/components/akutansi/listrekening/perpage"))

export default function Listrekening() {
    return (
        <>
