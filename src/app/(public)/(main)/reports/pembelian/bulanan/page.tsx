...
const TableList = dynamic(() => import("@/app/components/reports/pembelian/bulanan/table"))
const Pagination = dynamic(() => import("@/app/components/reports/pembelian/bulanan/pagination"))
const Tokopicker = dynamic(() => import("@/app/components/reports/pembelian/bulanan/tokopicker"))

export default function Pembelianbulanan() {
    return (
        <>
