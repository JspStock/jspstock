...
const TableList = dynamic(() => import("@/app/components/toko/table"))
const Pagination = dynamic(() => import("@/app/components/toko/pagination"))
const Perpage = dynamic(() => import("@/app/components/toko/perpage"))
