import { getData } from "@/app/(public)/(main)/dashboard/action"
...
const Stats = async ({ searchParams }: {
    ...
    const sales = data.sales.map(e => e.saleOrder.map(a => a.qty * a.product.price).reduce((val, prev) => val + prev)).reduce((val, prev) => val + prev, 0)
    ...
    return <>
        <div className="stats stats-vertical mt-5 gap-3 w-full">
            ...
            <div className="stat">
                ...
                <div className="stat-value">{currencyFormat(profit)}</div>
