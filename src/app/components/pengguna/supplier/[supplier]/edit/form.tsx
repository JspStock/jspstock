...
import { checkEmail, checkNoWa, updateSupplier } from "@/app/(public)/(main)/pengguna/supplier/[supplier]/edit/action"
import { Supplier } from "@/app/(public)/(main)/pengguna/supplier/[supplier]/edit/page"
...
const Form = ({ id, data }: { id: string, data: Supplier }) => {
